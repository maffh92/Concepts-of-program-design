...
object PerfectTree {
  ...
  implicit def frep2Perfect(implicit g : Generic2[Functions.Map]) : Base.FRep2[Functions.Map,Data.Perfect] = {
    new Base.FRep2[Functions.Map,Perfect] {
      override def frep2[A, B](g1: Map[A, B]): Map[Perfect[A], Perfect[B]] = perfecttree2(g1)
    }
  }

  implicit def frep2Fork(implicit g : Generic2[Functions.Map]) : Base.FRep2[Functions.Map,Data.Fork] = {
    new Base.FRep2[Functions.Map,Fork] {
